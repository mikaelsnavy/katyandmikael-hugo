...
(function ($) {
    ...
    "use strict";
        ...
        $('.slick1').slick({
            ...
            prevArrow:'<button class="arrow-slick1 prev-slick1"><span class="prev"></span></button>',
            nextArrow:'<button class="arrow-slick1 next-slick1"><span class="next"></span></button>',  
        });
        ...
        $('.slick2').slick({
            ...
            prevArrow:'<button class="arrow-slick2 prev-slick2"><span class="prev"></span></button>',
            nextArrow:'<button class="arrow-slick2 next-slick2"><span class="next"></span></button>',  
        });
        ...
        $('.slick3').slick({
            ...
            prevArrow:'<button class="arrow-slick3 prev-slick3"><span class="prev"></span></button>',
            nextArrow:'<button class="arrow-slick3 next-slick3"><span class="next"></span></button>',  
        });
